        ...
        if (Math.random() * 100 < 20 && !adjacentHasTree) {
          ...
          if (hasGrass) {
            ...
            for (int treex = x - 2; treex < x + 3; treex++) {
              for (int treey = groundLevel - treeHeight - 2; treey < groundLevel - treeHeight + 2;
                  treey++) {
  ...
  public void addCaves() {
    for (int x = 0; x < length - 10; x++) {
      ...
      if (dice < 5) {
        ...
        int yloc =
            (int) ((double) (height - groundlvlmap[x] - 20) * Math.random()) + groundlvlmap[x] + 20;
        ...
        for (int i = 0; i < cavelength; i++) {
          for (int ccavex = (cavex) - (cavegirth / 2); ccavex < cavex + (cavegirth / 2); ccavex++) {
            for (int ccavey = (cavey) - (cavegirth / 2); ccavey < cavey + (cavegirth / 2);
                ccavey++) {
