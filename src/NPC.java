...
public class NPC implements Sprite {
  ...
  public void draw(Graphics g, double p1x, double p1y, int mapLength) {
    ...
    g.fillRect((int) drawx - (int) ((maxhp * (BLOCKSIZE / 100.0)) / 2) + (width / 2),
        (int) drawy - BLOCKSIZE / 2, (int) (maxhp * (BLOCKSIZE / 100.0)), BLOCKSIZE / 3);
    g.setColor(Color.red);
    g.fillRect((int) drawx - (int) ((maxhp * (BLOCKSIZE / 100.0)) / 2) + (width / 2),
        (int) drawy - BLOCKSIZE / 2, (int) (hp * (BLOCKSIZE / 100.0)), BLOCKSIZE / 3);
  }
